    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950">
      <div className="max-w-7xl mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Kompleksowa analiza wydajności tradingowej</p>
            </div>
          </div>
          <Button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Card className="border-gray-800 bg-gradient-to-br from-blue-600/10 to-gray-900/80 backdrop-blur-sm">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-gray-400">Łączna liczba pozycji</p>
            ...
            <Card className="border-gray-800 bg-gradient-to-br from-purple-600/10 to-gray-900/80 backdrop-blur-sm">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-gray-400">USDT Total PnL</p>
            ...
            <Card className="border-gray-800 bg-gradient-to-br from-amber-600/10 to-gray-900/80 backdrop-blur-sm">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-gray-400">Stosunek zysk/strata</p>
                    ...
                    <div key={idx} className="p-4 rounded-lg border border-gray-800 bg-gray-900/50">
                      <div className="flex items-center justify-between mb-3">
                        <div>
                          ...
                          <p className="text-sm text-gray-400">{period.totalTrades} trades</p>
                        </div>
                        <Badge 
              ...
              <CardContent>
                {tierStats.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-gray-500">Brak danych o tierach</p>
                  </div>
                ) : (
                        ...
                        >
                          <div className="flex items-center justify-between mb-3">
                            <div>
                              ...
                              <p className="text-sm text-gray-400">{tier.totalTrades} trades</p>
                            </div>
            ...
            <Card className="border-gray-800 bg-gray-900/80 backdrop-blur-sm">
              ...
              <CardContent>
                {symbolStats.length === 0 ? (
                  <div className="text-center py-8">
                    <XCircle className="h-12 w-12 mx-auto mb-3 text-gray-600 opacity-50" />
                    <p className="text-sm text-gray-500">Brak danych o symbolach</p>
                  </div>
                ) : (
                  <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-500">{symbol.totalTrades} trades · {symbol.winRate.toFixed(1)}% WR</p>
                            </div>
                          </div>
                          <div className="text-right">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-4 rounded-lg bg-gray-800/50 border border-gray-700">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="font-semibold text-gray-300">Sharpe Ratio</h3>
                  </div>
                ...
                <div className="p-4 rounded-lg bg-gray-800/50 border border-gray-700">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="font-semibold text-gray-300">Max Drawdown</h3>
                  </div>
                  <p className="text-2xl font-bold text-red-400 mb-1">
                    -{stats.maxDrawdown.toFixed(2)} USDT
                  </p>
                  <p className="text-xs text-gray-500">Największy spadek z peak</p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-gray-800/50 border border-gray-700">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="font-semibold text-gray-300">Current Drawdown</h3>
                  </div>
                  <p className="text-2xl font-bold text-orange-400 mb-1">
                    -{stats.currentDrawdown.toFixed(2)} USDT
                  </p>
                  <p className="text-xs text-gray-500">Aktualny spadek z peak</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="border-gray-800 bg-gray-900/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-sm font-medium text-gray-400">Otrzymane Alerty</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-3xl font-bold text-white">{alerts.length}</p>
              <p className="text-xs text-gray-500 mt-1">Całkowita liczba alertów z TradingView</p>
            </CardContent>
          </Card>

          <Card className="border-gray-800 bg-gray-900/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-sm font-medium text-gray-400">Aktywne Pozycje</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-3xl font-bold text-white">{currentPositions.length}</p>
              <p className="text-xs text-gray-500 mt-1">Obecnie otwarte pozycje bota</p>
            </CardContent>
          </Card>

          <Card className="border-gray-800 bg-gray-900/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-sm font-medium text-gray-400">Zamknięte Pozycje</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-3xl font-bold text-white">{historicalPositions.length}</p>
              <p className="text-xs text-gray-500 mt-1">Historyczne, zamknięte pozycje</p>
            </CardContent>
          </Card>
        </div>
      </div>
